...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('goods', '0002_alter_categories_name_alter_product_name'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_address', models.TextField(blank=True, null=True, verbose_name='Адресс доставки')),
                ('payment_on_get', models.BooleanField(default=False, verbose_name='Оплата при получении')),
                ('is_paid', models.BooleanField(default=False, verbose_name='Оплачено')),
                ('status', models.CharField(default='В обработка', max_length=50, verbose_name='Статус заказа')),
